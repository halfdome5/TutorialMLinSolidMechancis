...
def plot_potential(W, W_ana):
    ...
    plt.plot(x, W_ana, color='firebrick', label='prediction')
    plt.xlabel('load step')
    plt.ylabel(r'$W$')
    plt.xlim(np.min(x), np.max(x))
    plt.grid()
...
def plot_stress_tensor_analytical(P, P_ana):
    ...
    plt.plot(x, P[:, 0, 1], color='cornflowerblue', linestyle='None', marker='s', markevery=13, label=r'$P_{12}$')
    plt.plot(x, P[:, 0, 2], color='lightgrey', linestyle='None', marker='s', markevery=14, label=r'$P_{13}$')
    plt.plot(x, P[:, 1, 0], color='green', linestyle='None', marker='s', markevery=15, label=r'$P_{21}$')
    plt.plot(x, P[:, 1, 1], color='navy', linestyle='None', marker='s', markevery=11, label=r'$P_{22}$')
    plt.plot(x, P[:, 1, 2], color='lightgrey', linestyle='None', marker='s', markevery=16, label=r'$P_{23}$')
    plt.plot(x, P[:, 2, 0], color='lightgrey', linestyle='None', marker='s', markevery=17, label=r'$P_{31}$')
    plt.plot(x, P[:, 2, 1], color='lightgrey', linestyle='None', marker='s', markevery=18, label=r'$P_{32}$')
